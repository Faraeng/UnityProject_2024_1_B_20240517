...
public class AchievementManager : MonoBehaviour
{
    ...
    public List<Achievement> achievements;                  //Achievement 클래스를 List로 분리
    ...
    private void Awake()
    {
        ...
        {
            instance = this;
            DontDestroyOnLoad(gameObject);                 //다른 Scene에서도 적용하기 위해서 파괴되지 않게 설정
        }
        else
        {
            Destroy(gameObject);
    ...
    public void AddAchievement(Achievement achievement)
    {
        ...
        achievements.Add(achievement);                                                     //List 업적 추가
